...
def Registerpage(request):
    ...
    if request.method=='GET':
       image2 = get_object_or_404(paypage, Name='logo3') 
       image6=get_object_or_404(paypage, Name='inst') 
       image7=get_object_or_404(paypage, Name='twitter')
       image8=get_object_or_404(paypage, Name='wats')      
...
def loginpage(request):
    ...
    return render(request, 'login.html', {'form': form,'image2':image2,'image6':image6,
        'image7':image7,
        'image8':image8,})
...
def Entertainmentpage(request):
    if request.method=='POST':
     ...
     image3 = get_object_or_404(paypage, Name='logo3')
     image6=get_object_or_404(paypage, Name='inst') 
     image7=get_object_or_404(paypage, Name='twitter')
     image8=get_object_or_404(paypage, Name='wats')     
...
def cart_detail(request):
    ...
    return render(request,'cart_detail.html',{'cart':cart,'buyer':buyer,'cart_items':cart_items,'image1':image1,'image0':image0,'image2':image2,'image6':image6,'image7':image7,'image8':image8,})
...
def networkform(request):
    if request.method=='GET':
     image = get_object_or_404(paypage, Name='Vodacom')
     image5 = get_object_or_404(paypage, Name='Tigo')
...
def industrybuyer(request):
    ...
    return render(request,'industrybuyer.html',{'cart':cart,'cart_items':cart_items,'image1':image1,
        'image0':image0,'image2':image2,'image6':image6,'image7':image7,'image8':image8,})
...
def watchbuyer(request):
    ...
    return render(request,'watchbuyer.html',{'cart':cart,'cart_items':cart_items,'image1':image1,'image0':image0,'image2':image2,
        'image6':image6,
        'image7':image7,
        'image8':image8,})
...
def Fashionseller(request):
   ...
   image7=get_object_or_404(paypage, Name='twitter')
   image8=get_object_or_404(paypage, Name='wats')  
   return render(request,'Fashionseller.html',{'qs':qs,'image1':image1,'image0':image0,'image2':image2,
        'image6':image6,
        'image7':image7,
        'image8':image8,})
...
def Shoeseller(request):
   ...
   return render(request,'shoeseller.html',{'qs':qs,'image1':image1,'image0':image0,'image2':image2,
        'image6':image6,
        'image7':image7,
        'image8':image8,})
...
def userdetail(request):
    ...
    return render(request,'user.html',{'user':user,'image2':image2,
        'image6':image6,
        'image7':image7,
        'image8':image8,})
